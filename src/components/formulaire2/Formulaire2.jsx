...
function App() {
  ...
  const selectclasse = async () => {
    const result = await Axios.get('http://localhost:5000/selectclasseterminale');
    ...
    <div>
      ...
      <div className='page'>
        ...
        <div className="formulaire">
          <h2 className='lohany' style={{ textAlign: 'center', color: '#205375' }}>Inscription niveau terminale</h2>
