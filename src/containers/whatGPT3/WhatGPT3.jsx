...
return(
  <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
    <div className="gpt3__whatgpt3-feature">
      <Feature title="Notre services" text="Le Club des Professeurs Expérimentés (CPE) est une organisation ou un service éducatif qui propose des cours de préparation à l'examen du BEPC (Brevet d'Études du Premier Cycle) et du Baccalauréat, principalement à Madagascar." />
    </div>
