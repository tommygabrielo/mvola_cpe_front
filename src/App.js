...
import { Footer, Features, WhatGPT3, Blog, Header } from './containers';
import { Navbar, Login, Formulaire, Formulaire2, UserInterface, Renseignement, Historique, LigneRecu } from './components';
import './App.css';
  ...
  return (
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          {/* ... Vos autres routes ... */}
          <Route path="*" element={<><Navbar /><Header /><WhatGPT3 /><Features /> < Blog /> <Footer /></>} />
          <Route path="/" element={<><Navbar /><Header /><WhatGPT3 /><Features /> < Blog /> <Footer /></>} />
